...
// @version          1.0
// @author           legnaleurc
// @namespace        https://github.com/legnaleurc/gm_emulation
// @include          http://*
// @include          https://*
// @filename         gm_emulation.user.js
// @filename-IE      gm_emulation.ieuser.js
// @filename-opera   gm_emulation.js
// @uniquescriptname gm_emulation
// @license          GPL version 3 or any later version; http://www.gnu.org/copyleft/gpl.html
// ==/UserScript==

(function()
{
  var SCRIPT_URL = 'https://raw.githubusercontent.com/legnaleurc/gm_emulation/master/gm_emulation.user.js';
  ...
  var version = "1.0";
  var unique_script_name = "gm_emulation";
  ...
  var handle_update_function = function(new_version)
  {
    if(new_version != null && new_version != false)
    {
      ...
      if(result)
        try { location.href = SCRIPT_URL; } catch(e) {}
    }
  };

  // this will only run in Firefox, IE and Opera (with scriptStorage active)
  gm_extensions.GM_updateCheck(SCRIPT_URL, version, 10, handle_update_function, unique_script_name);
})();
